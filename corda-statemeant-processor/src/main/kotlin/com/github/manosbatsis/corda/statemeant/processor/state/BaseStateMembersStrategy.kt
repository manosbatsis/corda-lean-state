...
import com.github.manosbatsis.corda.statemeant.processor.state.mapping.PersistentPropertyMapperCache
...
abstract class BaseStateMembersStrategy(
    ...
    fun getPersistentMappingModes(variableElement: VariableElement): List<StatemeantPropertyMappingMode> {
        return variableElement.getAnnotation(StatemeantProperty::class.java)?.persistentMappingModes?.toList()
                ?: annotatedElementInfo.primaryTargetTypeElement
                        .getAnnotation(StatemeantType::class.java)!!.persistentMappingModes.toList()
