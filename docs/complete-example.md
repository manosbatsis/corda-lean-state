...
interface NewsPaper: LinearState, QueryableState {
    ...
    // Only add if you don't want the implementation generated by default
    ...
    // Only add if you explicitly implement supportedSchemas() above
    //object Schema
...
) : NewsPaperContract.NewsPaper, ParticipantsState {
